...
Fernet symmetric encryption (AES-128-CBC + HMAC-SHA256).  The encryption
key is auto-generated on first use and stored in ``<data_dir>/secret.key``.
Settings are stored as a JSON file at ``<data_dir>/settings.json``.
